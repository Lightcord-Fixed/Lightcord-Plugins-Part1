...
module.exports = class MessageLoggerV2 {
  ...
  getDescription() {
    return 'Lighty Message Logger Fixed by Riolubruh Thanks to him';
  ...
  initialize() {
	...
	// Remove annoying message when using Lightcord.
    let defaultSettings = {
  ...
  onDispatchEvent(args, callDefault) {
    ...
    try {
      ...
      if (guild) {
        ...
        channelIgnoreReturn = (this.settings.ignoreNSFW && channel.nsfw && !channelWhitelisted || this.settings.ignoreMutedChannels);
      }
